...
EMCC_FLAGS  = -std=c++17 -O3 \
              ...
              -s GL_UNSAFE_OPTS=1 \
              -s EXPORTED_FUNCTIONS="['_main','_wasm_restart_game','_wasm_get_score','_wasm_set_move_up','_wasm_set_move_down','_wasm_set_move_left','_wasm_set_move_right','_wasm_set_shooting','_wasm_press_start','_wasm_is_paused']" \
